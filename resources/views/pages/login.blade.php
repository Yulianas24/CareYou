...
<body>
    ...
    <div class="grid phone:grid-rows-2 laptop:grid-cols-7 laptop:grid-rows-none w-screen h-screen">

        {{-- ?: CareYou  Container --}}
        <div class="bg-blue-901 flex relative col-span-3">
            <div class="flex justify-between flex-col h-32 w-96 absolute top-44 left-16 ">
                <picture>
                    <source media="(min-width:320px)" srcset="/asset/logo_blue.svg">
                    <source media="(min-width:800px)" srcset="/asset/logo.svg">
