        ...
        <div class="flex flex-col w-full md:space-y-4">
            ...
            <header class=" w-full h-16  fixed z-10 dark:bg-gray-800 border-b border-gray-700 flex items-center justify-between pb-2">
                ...
                <div class="block  ml-6">
                    <label class="flex  hover:cursor-pointer laptop:hidden">
                        
                        <picture class="flex p-2 items-center rounded-full bg-white shadow text-gray-500 text-md ">
                        ...
                        {{-- Mobile Sidebar --}}
                        <div class="hidden peer-checked:block laptop:hidden fixed top-7 h-auto  z-20  shadow-lg w-52">
                ...
                <div class="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                    <div class="relative p-1 flex items-center w-full space-x-4 justify-end">
                        ...
                        <label class="flex hover:cursor-pointer">
                            <picture href="#" class=" block relative">
                                @if (auth()->user()->image)
                            ...
                            <div class=" flex items-center text-gray-500 dark:text-white text-md ml-3">
                                {{ auth()->user()->username }}
                            ...
                            <input type="checkbox" class="peer hidden">
                            {{-- Nav content --}}
                                <div class="hidden peer-checked:block  absolute top-12 right-0 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"  >
            ...
            {{-- Sidebar --}}
            <div class="hidden peer-hover:block laptop:block fixed h-full  z-20  shadow-lg w-56">
                <div class="bg-white h-full dark:bg-gray-700">
            ...
            {{-- content --}}
            <div class="h-screen laptop:ml-56 mt-16">
                @yield('dashboard')
            </div>
