...
<div class="h-102 w-94 rounded-3xl flex flex-col bg-white justify-start">
    ...
    <figure class="flex flex-col items-center h-44 w-full mt-3">
        ...
        <figcaption class="h-full w-1/1.2">
            <ul class="flex flex-col h-full w-full justify-evenly">
                ...
                <li class="flex" font-roboto=""><img class="mx-5" src="/asset/icons/checklist.svg" alt="">{{   $masalah[0][$i]   }}</li>
                @endfor
            </ul>
        </figcaption>
    </figure>
    ...
    <figure class="flex w-full h-full items-center justify-center">
        <a href="/konselor/{{ $konselor[0]->username }}">
            <figcaption class="flex items-center bg-blue-902 h-10 px-7 text-white rounded-lg cursor-pointer">Lihat Profil Lengkap
            </figcaption>
        </a>
    </figure>
</div>
    ...
    <figure class="flex flex-col items-center h-44 w-full mt-3">
        ...
        <figcaption class="h-full w-1/1.2">
            <ul class="flex flex-col h-full w-full justify-evenly">
                ...
                <li class="flex" font-roboto=""><img class="mx-5" src="/asset/icons/checklist.svg" alt="">{{   $masalah[1][$i]   }}</li>
                @endfor
            </ul>
        </figcaption>
    </figure>
    ...
    <figure class="flex flex-col items-center h-44 w-full mt-3">
        ...
        <figcaption class="h-full w-1/1.2">
            <ul class="flex flex-col h-full w-full justify-evenly">
                ...
                <li class="flex" font-roboto=""><img class="mx-5" src="/asset/icons/checklist.svg" alt="">{{   $masalah[2][$i]   }}</li>
                @endfor
            </ul>
        </figcaption>
    </figure>
