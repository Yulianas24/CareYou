     ...
     <div class="flex flex-col w-full h-full mt-4 p-2">
         ...
         <div class="flex justify-between w-1/1.2 mt-8">
             ...
             <div class="flex flex-col w-[48%]">
                 ...
                 <button class="font-roboto my-2 bg-blue-902 py-3 px-1 text-white rounded-lg">Pilih Konsultasi
                     Online</button>
             </div>
             <div class="flex flex-col w-[48%]">
                 ...
                 <button booking-konselor class="font-roboto my-2 bg-blue-902 py-3 px-1 text-white rounded-lg">Pilih
                     Konsultasi
                     Online</button>
             </div>
         </div>
