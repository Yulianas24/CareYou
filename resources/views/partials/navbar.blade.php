<nav class="flex justify-evenly fixed items-center w-screen h-18 bg-transparent z-50">
    ...
    <a href="#" class="peer block relative">
        ...
        <button class="peer flex -ml-5 text-gray-500 dark:text-white text-md">
            {{ auth()->user()->username }}
        ...
        <div class="hidden peer-hover:block hover:block absolute top-12 right-12 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"  >
