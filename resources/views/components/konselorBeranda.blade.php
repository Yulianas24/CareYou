...
<div class="w-screen min-h-screen h-fit flex flex-col justify-evenly laptop:justify-center desktop:justify-evenly items-center "
    id="pageKonselor">
    {{-- ?: Container Text --}}
   ...
   <div class="w-screen h-fit">
    ...
    <figure class="flex items-center cursor-pointer w-full px-2 laptop:w-1/1.2 justify-end mt-4">
